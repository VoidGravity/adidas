    ...
    <section id="wrapper">
        ...
        <div class="p-4">
            ...
            <div class="bg-gray-900 h-screen flex flex-col items-center justify-center text-center">
                ...
                <div class="mt-8">
                    <form action="{{ route('categorys.store') }}" method="post" class="flex flex-col items-center" enctype="multipart/form-data">
                        <input type="text" name="name" placeholder="Your category's Name"
                        ...
                        <textarea rows="4"type="text" name="description"
                            class="py-2 px-4 bg-gray-800 text-white rounded-md focus:outline-none mb-4" placeholder="Your category's Description"
                            required @if (session('description')) value=" {{ old('description') }}" @endif></textarea>
                        <input type="text" name="price" placeholder="Your category's Price"
                            class="py-2 px-4 bg-gray-800 text-white rounded-md focus:outline-none mb-4" required
                        ...
                        <input type="text" name="tags" placeholder="Your category's tags"
                            class="py-2 px-4 bg-gray-800 text-white rounded-md focus:outline-none mb-4" required />
