...
-------------------------------- */
        ...
        ::-webkit-scrollbar-thumb:hover {
            background-color: rgba(151, 25, 25, 0.3);
        }
    </style>
</head>
    ...
    <section id="wrapper">
        ...
        <div class="p-4">
            ...
            <div class="bg-gray-900 h-screen flex flex-col items-center justify-center text-center">
                ...
                <div class="mt-8">
                    <form action="{{ url('category/'.$category->id.'/edit') }}" method="post" class="flex flex-col items-center" enctype="multipart/form-data">
                        @csrf
                        <input type="text" name="name" placeholder="Your category's Name"
                            ...
                            value=" {{ $category->name }}" />
                        <input rows="4"type="text" name="description"
