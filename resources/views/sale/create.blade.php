                        ...
                        <div class="d-flex justify-content-between">
                            <div>
                                ...
                                <textarea rows="4"type="text" name="notes"
                                    class="py-2 px-4 bg-gray-800 text-white rounded-md focus:outline-none mb-4" placeholder="Your Notes" required></textarea>

                            </div>
                            <div>
                                <input type="date" name="date" placeholder="Your Product's tags"
