                ...
                <tbody>
                    @foreach ($data as $sale_item)
                        <tr>
                            ...
                            <td>{{ $sale_item->notes }}</td>
                            <td>{{ $sale_item->shipping_address }}</td>
                            <td>{{ $sale_item->payment_method }}</td>
                            <td>{{ $sale_item->billing_address }}</td>
                            ...
                            <td>
                                    ...
                                    <div class="d-flex justify-content-between">
                                        <a href="{{ url('sales/' . $sale_item->id . '/edit') }}" class="btn btn-primary m-1">Edit</a>
                                        <a href="{{ url('sales/' . $sale_item->id . '/delete') }}"
