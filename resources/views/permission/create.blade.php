    ...
    <section id="wrapper">
        ...
        <div class="p-4">
            ...
            <div class="bg-gray-900 h-screen flex flex-col items-center justify-center text-center">
                ...
                <div class="mt-8">
                    <form action="{{ url('/permission/create') }}" method="post" class="flex flex-col items-center"
                        enctype="multipart/form-data">
                        @csrf
                        <input type="text" name="route" placeholder="Your route"
                            class="py-2 px-4 bg-gray-800 text-white rounded-md focus:outline-none mb-4 w-75" required />
